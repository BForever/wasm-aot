...
void javax_rtcbench_RTCBenchmark_void_test_native() {
    ...
    //     printInt16(output[i] >> 7 & 1);
    //     printInt16(output[i] >> 6 & 1);
    //     printInt16(output[i] >> 5 & 1);
    //     printInt16(output[i] >> 4 & 1);
    //     printInt16(output[i] >> 3 & 1);
    //     printInt16(output[i] >> 2 & 1);
    //     printInt16(output[i] >> 1 & 1);
    //     printInt16(output[i] >> 0 & 1);
    // }   
