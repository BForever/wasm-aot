...
void __attribute__((noinline)) rtcbenchmark_measure_native_performance_outlier(uint16_t NUMNUMBERS, int32_t buffer[], uint32_t distance_matrix[], uint32_t distance_threshold, unsigned char outliers[]) {
