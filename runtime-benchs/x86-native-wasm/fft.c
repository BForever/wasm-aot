#include "measure.h"
#define MICA2_PLATFORM

// Taken from SOS sources
// https://github.com/nesl/sos-2x
...
int16_t __attribute__((noinline)) rtcbenchmark_measure_native_performance_fft(int16_t *fr, int16_t *fi, int16_t m, int16_t inverse)
{
...
void rtcbench_fft() {
	...
	rtcbenchmark_measure_native_performance_fft(data, im, RTCTEST_FFT_ARRAYSIZE, 0);
