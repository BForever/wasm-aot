...
cd ../app/benchmark
wat2wasm binsrch.c.wat -o binsrch.wasm --enable-annotations -v
xxd -i binsrch.wasm > binsrch.wasm.h
sed -i "s#char#char\ __attribute__\ ((section\ (\".rtc_code_marker\")))"# binsrch.wasm.h
